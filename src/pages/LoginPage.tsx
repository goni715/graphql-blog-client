...
import { Mail, Lock, Eye, EyeOff, LogIn, ArrowLeft, Loader2, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-slate-950 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute -bottom-40 -right-40 h-[600px] w-[600px] rounded-full bg-purple-600/10 blur-[120px] pointer-events-none"></div>
      </div>
